                            ...
                            <li class="nav-space nav-item dropdown active">
                                ...
                                <div class="dropdown-menu drop-down-content">
                                    <ul class="list-unstyled drop-down-pages">
                                        ...
                                        <li class="nav-item active"><a class="dropdown-item nav-link" href="load-more.html">Load More</a></li>
          ...
          <div id="blog" class="three-column col-xl-12">
             <div class="row">
                ...
                <div class="load-more d-inline-block m-auto align-top">
                   <a class="d-block" href="single-post.html">Load More</a>
                </div>
             </div>
             <!--blog-->
          </div>
