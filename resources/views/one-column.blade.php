...
<html lang="zxx">
<head>
    <title>One Column | Esignax</title>
    <!-- /SEO Ultimate -->
                            ...
                            <li class="nav-space nav-item dropdown active">
                                ...
                                <div class="dropdown-menu drop-down-content">
                                    <ul class="list-unstyled drop-down-pages">
                                        ...
                                        <li class="nav-item active"><a class="dropdown-item nav-link" href="one-column.html">One Column</a></li>
                ...
                <div class="float-left w-100 post-item border mb-4">
                   <div class="post-item-wrap position-relative">
                      <div class="post-audio position-relative">
                         <a href="#">
                         <img alt="" src="assets/images/post-featured.jpg"> </a>
                         <span class="post-meta-category">
                         <a href="">Audio</a>
                         </span>
