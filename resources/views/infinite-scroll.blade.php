...
<html lang="zxx">
<head>
    <title>Infinite Scroll | Esignax</title>
    <!-- /SEO Ultimate -->
                            ...
                            <li class="nav-space nav-item dropdown active">
                                ...
                                <div class="dropdown-menu drop-down-content">
                                    <ul class="list-unstyled drop-down-pages">
                                        ...
                                        <li class="nav-item active"><a class="dropdown-item nav-link" href="infinite-scroll.html">Infinite Scroll</a></li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="banner_content" data-aos="fade-up">
                        ...
                        <h1 class="text-white">Infinite Scroll</h1>
                        ...
                        <div class="box">
                            ...
                            <span class="mb-0 box_span">Infinite Scroll</span>
                        </div>
                    </div>
                </div>
            </div>
