...
@section('title', 'For Businesses - Esignax')
@section('content')
    <style>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12 order-lg-2 order-1">
                    <div class="service_content position-relative" data-aos="fade-right">
                        ...
                        <h2 class="mt-5">For Businesses</h2>
                        <p>Users can have complete digital solutions for their business documents through fluid end-to-end
                            services including e-sign, notarization, document tracing and document verification.</p>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="expert_content" data-aos="fade-right">
                        ...
                        <a class="get_started text-white text-decoration-none mt-3" href="./team.html">Sign Your Document
                            <figure class="mb-0"><img src="{{ asset('assets/images/button-arrow.png') }}"
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="expert_wrapper">
                        ...
                        <img class="mt-3 individual_third w-75"
                            src="{{ asset('assets/images/for-businesses-third-sec.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="upper_portion">
                            <div class="image_content">
                                <figure class="offer-icon">
                                    <i class="fa-solid fa-user mt-md-4 mt-3 why_icons"></i>
                                </figure>
                            </div>
                        </div>
                        ...
                        <div class="upper_portion">
                            <div class="image_content">
                                <figure class="offer-icon offer-icon2">
                                    <i class="fa-solid fa-file-lines mt-md-4 mt-3 why_icons"></i>
                                </figure>
                            </div>
                        </div>
                        <div class="lower_portion_wrapper">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 article_padding">
                    <div class="offer_boxcontent mb-0">
                        <div class="upper_portion">
                            <div class="image_content">
                                <figure class="offer-icon">
                                    <i class="fa-brands fa-telegram mt-md-4 mt-3 why_icons"></i>
                                </figure>
                            </div>
                        </div>
                        <div class="lower_portion_wrapper">
